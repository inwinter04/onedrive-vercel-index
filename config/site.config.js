...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'inwinter04@iamdongtian.onmicrosoft.com',
  ...
  email: 'mailto:inwinter04@163.com',
  ...
  links: [
    ...
    {
      name: 'GitHub',
      link: 'https://github.com/inwinter04',
    },
  ],
